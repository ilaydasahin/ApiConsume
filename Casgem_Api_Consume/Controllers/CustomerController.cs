...
namespace Casgem_Api_Consume.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44364/api/Customer");
        ...
        public async Task<IActionResult> AddCustomer(CreateCustomerDto createCustomerDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:44364/api/Customer", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
